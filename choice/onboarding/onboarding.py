            ...
            with requests.Session() as s:
                ...
                if serverkey is not None:
                    ...
                    try:
                        ...
                        print(error_message)
                        error_temp=error_message[:250]
                        errorMessage = errorMessage + " REVENUE DETAIL Parsing Failed: " + error_temp
                    ...
                    try:
                        ...
                        print(error_message)
                        error_temp=error_message[:250]
                        errorMessage = errorMessage + " GROUP PICKUP DETAIL Parsing Failed: " + error_temp
                    ...
                    try:
                        ...
                        print(error_message)
                        error_temp=error_message[:250]
                        errorMessage = errorMessage + " CANCELLATION LIST Parsing Failed: " + error_temp
                    ...
                    try:
                        ...
                        print(error_message)
                        error_temp=error_message[:250]
                        errorMessage = errorMessage + " Noshow Parsing Failed: " + error_temp
