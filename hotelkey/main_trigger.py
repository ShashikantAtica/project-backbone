...
username = "piyush@aticastays.com"
password = "Manchester@2023"
external_property_code = "Rockford, IL"
login_url = "https://motel6.aboveproperty.com/#/login"
send_email = "us15.mail@aticastays.com"
...
try:
    with requests.Session() as s:
        ...
        occ_start_date = arrow.now().shift(days=-1).format("YYYY-MM-DD")
        occ_end_date = arrow.now().shift(days=90).format("YYYY-MM-DD")
